...
class YoutubeDownloader:
    ...
    def __init__(self):
        ...
        self.window.configure(bg="#ba8d1c")
        self.window.title(WINDOW_TITLE)

        self.link_label = tk.Label(self.window, text = "Video Url: ")
        self.link_label.grid(column = 0, row = 0)
        self.name_label = tk.Label(self.window, text = "File Name: ")
        ...
        #self.ext_label = tk.Label(self.window, text = "File Format: ")
    ...
    def __get_link(self):
        ...
        self.__downloader(link, path, name)
